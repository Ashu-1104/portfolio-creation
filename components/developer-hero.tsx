      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="grid lg:grid-cols-[1.5fr_1fr] gap-16 items-center">
          <div className="space-y-8">
            ...
            >
              I build robust, high-performance systems and scalable web applications. Currently architecting SEO-optimized interfaces and AI-driven solutions at <span className="text-emerald-500 font-medium">Akobot.ai</span>. Specialized in Next.js 15, PHP, and System Administration.
            </motion.p>
