...
export function DeveloperFooter() {
  ...
  return (
    <footer className="py-12 px-6 bg-[#09090b] border-t border-zinc-900">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-zinc-800 flex items-center justify-center rounded text-emerald-500">
            <Terminal size={14} />
          </div>
        ...
        <p className="text-zinc-600 text-xs font-mono uppercase tracking-widest">
          &copy; {currentYear} // Designed and coded by Ashutosh Tiwari
        </p>
